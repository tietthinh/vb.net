...
/*  Created On : 04-Dec-2015 1:37:43 PM 				*/
...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruDatMon]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruDatMon]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruCTDatMon]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruCTDatMon]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruNhanVien]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruNhanVien]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruLichLamViec]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruLichLamViec]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruPhieuNhap]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruPhieuNhap]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruCTPhieuNhap]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruCTPhieuNhap]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruMonAnDoUong]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruMonAnDoUong]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruPhieuNhan]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruPhieuNhan]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruCTPhieuNhan]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruCTPhieuNhan]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruCTLamMon]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruCTLamMon]
GO

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[LuuTruSanPham]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
DROP TABLE [LuuTruSanPham]
GO
...
(
	...
	[TenDV] nvarchar(8) NULL,    -- Ðon vi tinh:  	- Chai  DVT: 1 	- Lon  DVT:1 	- Kg DVT:0.2 	- ml DVT:100ml 	- Qua/Trai  DVT: 1 	- Cai  DVT:1 	- Hop DVT:1 	- Hu DVT:1 	- Bich DVT:1
...
CREATE TABLE [LuuTruLichLamViec]
(
	[MaNV] char(10) NULL,
...
CREATE TABLE [LuuTruCTPhieuNhap]
(
	[MaPN] char(10) NULL,
	[MaSP] char(10) NULL,
	[SoLuong] int NULL,
...
CREATE TABLE [LuuTruMonAnDoUong]
(
	[MaMon] char(10) NULL,
...
CREATE TABLE [LuuTruCTPhieuNhan]
(
	[MaPG] char(10) NULL,
	[MaSP] char(10) NULL,
	[SoLuong] int NULL,
...
EXEC sp_addextendedproperty 'MS_Description', 'Ðon vi tinh:  	- Chai  DVT: 1 	- Lon  DVT:1 	- Kg DVT:0.2 	- ml DVT:100ml 	- Qua/Trai  DVT: 1 	- Cai  DVT:1 	- Hop DVT:1 	- Hu DVT:1 	- Bich DVT:1', 'Schema', [dbo], 'table', [LoaiDonViTinh], 'column', [TenDV]
GO
